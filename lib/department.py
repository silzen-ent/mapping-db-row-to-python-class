...
class Department:
    ...
    all = {} # Dict of objects saved to the DB
    ...
    def save(self):
        ...
        type(self).all[self.id] = self # Updated save method to add current Dept. instance  to the dict (all) using the row's PK as the dict key. 
